...
void free_everything_germ(int size, int** matrix, int* vector)
{
...
void print_vector_germ(int size, int* vector)
{
...
void print_matrix_germ(int size, int** matrix)
{
...
int main(int argc, char *argv[])
{
    ...
    print_matrix_germ(size, matrix);
    print_vector_germ(size, vector);

    free_everything_germ(size, matrix, vector);
