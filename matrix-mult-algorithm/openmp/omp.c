...
/* https://www.softwareresearch.net/fileadmin/src/docs/teaching/SS12/SaI/Gfrerer_paper.pdf Capítulo 3.2
   https://www.eidos.ic.i.u-tokyo.ac.jp/~tau/lecture/parallel_distributed/2018/slides/pdf/openmp2.pdf
*/
...
void compute_multiplication(int size, int nz, int* vector, int* row_ind, int* col_ind,
...
int main(int argc, char *argv[])
{
    ...
    compute_multiplication((*size), nz, vector, row_ind, col_ind, values, solution);
